...
class Ui_MainClientWindow(object):
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        self.label_new_message.setText(
            _translate("MainClientWindow", "Введите текст сообщения:")
        )
