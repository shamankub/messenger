...
* ``python -n user1 -p 123``

*Запуск приложения с пользователем user1 и паролем 123*

* ``python client.py ip_address some_port -n user1 -p 123``

*Запуск приложения с пользователем user1 и паролем 123 и указанием подключаться к серверу по адресу ip_address:port*
